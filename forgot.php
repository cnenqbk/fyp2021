    ...
    <body>
                    ...
                    if (isset($_POST["email"]) && (!empty($_POST["email"]))) {
                        ...
                        if (!$email) {
                            ...
                            $sel_query = "SELECT * FROM `member` WHERE email='" . $email . "'";
                        ...
                        if ($error!="") {
                            ...
                            $output.='<p><a href="https://cwtxyz.tk/reset-password?key=' . $key . '&email=' . $email . '&action=reset" target="_blank">https://cwtxyz.tk/reset-password?key=' . $key . '&email=' . $email . '&action=reset</a></p>';
                            $body = $output;
