...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <a class="navbar-brand">Earphones</a>
</div>
  ...
  <a class="dropdown-item" href="prod(login)">All Types</a>
    <a class="dropdown-item" href="prodUSB(login)">USB</a>
    <a class="dropdown-item" href="prodChar(login)">Charges</a>
    <a class="dropdown-item" href="prodPB(login)">Power Bank</a>
  </div>
</div>
        </li>
      
        <li class="nav-item">
        <a href="profile" class="btn btn-dark" role="button">My Profile</a>
        </li>
        <li class="nav-item">
        <a onclick="myFunction1()" href="logout.php" class="btn btn-dark" role="button">Log Out</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row mt-2 pb-3">
      <?php
        ...
        include 'config.php';
  			...
  			$stmt = $conn->prepare('SELECT * FROM product WHERE product_type="Earphones"');
  			$stmt->execute();
